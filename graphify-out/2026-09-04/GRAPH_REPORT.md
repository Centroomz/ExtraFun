# Graph Report - morefun  (2026-09-04)

## Corpus Check
- 79 files · ~154,579 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 329 nodes · 410 edges · 36 communities (30 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `31982fe9`
...
## Knowledge Gaps
- **108 isolated node(s):** `MONTH_THEMES`, `POST_CATEGORIES`, `CAT_EMOJI`, `DEMO_ADS`, `TYPE_CONFIG` (+103 more)
...
- **What connects `MONTH_THEMES`, `POST_CATEGORIES`, `CAT_EMOJI` to the rest of the system?**
