# Graph Report - morefun  (2026-08-31)

## Corpus Check
- 78 files · ~153,246 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 318 nodes · 402 edges · 35 communities (29 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e73d08e6`
...
- `QuizView()` --calls--> `interpretQuizResult()`  [EXTRACTED]
  src/pages/Magazyn.jsx → src/lib/quiz-dogging.js
...
Cohesion: 0.29
Nodes (8): interpretQuizResult(), QUIZ_QUESTIONS, RESULTS, TYPE_MAP, estimateReadingTime(), Magazyn(), QuizView(), SLUG_TO_DISPLAY
...
## Knowledge Gaps
- **105 isolated node(s):** `TYPE_MAP`, `RESULTS`, `SLUG_TO_DISPLAY`, `__dirname`, `ROOT` (+100 more)
...
- **What connects `TYPE_MAP`, `RESULTS`, `SLUG_TO_DISPLAY` to the rest of the system?**
