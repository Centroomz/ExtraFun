# Graph Report - morefun  (2026-08-07)

## Corpus Check
- 72 files · ~143,010 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 267 nodes · 467 edges · 19 communities (16 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5bf1cfe1`
...
Cohesion: 0.13
Nodes (16): ADMIN_EMAILS, App(), AppInner(), DesktopNav(), isAdmin(), NAV_ITEMS, LoginPage(), SignupPage() (+8 more)
...
- **Why does `Hero()` connect `Shared UI Components` to `Geolocation and Guides`, `Vocabulary Lookup Tool`, `News Feed and Translation`, `Content and Quiz Display`?**
