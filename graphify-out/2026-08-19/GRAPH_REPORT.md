...
## Corpus Check
- 75 files · ~148,430 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 307 nodes · 513 edges · 21 communities (18 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9b55a62f`
...
Cohesion: 0.08
Nodes (32): ADMIN_EMAILS, App(), AppInner(), DesktopNav(), isAdmin(), NAV_ITEMS, LoginPage(), SignupPage() (+24 more)
...
Cohesion: 0.17
Nodes (11): AgeGate(), ArticleCard(), Button(), DiamondRating(), Hero(), SectionHeader(), DAY_PL, formatDate() (+3 more)
