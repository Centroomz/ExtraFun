...
## Corpus Check
- 75 files · ~149,610 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 309 nodes · 437 edges · 28 communities (23 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d74489ea`
...
6. `Button()` - 7 edges
7. `esc()` - 6 edges
8. `Przewodnik()` - 6 edges
9. `ExtraFun Finder Implementation Plan` - 6 edges
10. `isFemaleNick()` - 6 edges
...
## Knowledge Gaps
- **105 isolated node(s):** `DEMO_ADS`, `DISTANCE_FILTERS`, `__dirname`, `ROOT`, `DIST` (+100 more)
...
- **What connects `DEMO_ADS`, `DISTANCE_FILTERS`, `__dirname` to the rest of the system?**
