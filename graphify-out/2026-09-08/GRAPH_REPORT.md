# Graph Report - morefun  (2026-09-08)

## Corpus Check
- 79 files · ~154,599 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 329 nodes · 398 edges · 37 communities (30 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `14eb12e2`
...
2. `Plaze()` - 8 edges
3. `Przewodnik()` - 7 edges
4. `useAuth()` - 7 edges
5. `Aktualnosci()` - 7 edges
6. `esc()` - 6 edges
...
Cohesion: 0.18
Nodes (9): ADMIN_EMAILS, App(), AppInner(), DesktopNav(), isAdmin(), NAV_ITEMS, SignupPage(), PWAInstallBanner() (+1 more)

## Knowledge Gaps
- **107 isolated node(s):** `NAV_ITEMS`, `TYPE_LABEL`, `TYPE_ICON`, `SORT_OPTIONS`, `DEMO_THREADS` (+102 more)
...
- **What connects `NAV_ITEMS`, `TYPE_LABEL`, `TYPE_ICON` to the rest of the system?**
