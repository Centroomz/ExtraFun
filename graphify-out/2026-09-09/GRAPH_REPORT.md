# Graph Report - morefun  (2026-09-09)

## Corpus Check
- 79 files · ~194,892 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 331 nodes · 394 edges · 40 communities (34 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `36b29fe2`
...
## Knowledge Gaps
- **106 isolated node(s):** `CATEGORY_COLORS`, `AUTHOR_AVATARS`, `SLUG_TO_DISPLAY`, `CTA_MAP`, `CTA_DEFAULT` (+101 more)
...
- **What connects `CATEGORY_COLORS`, `AUTHOR_AVATARS`, `SLUG_TO_DISPLAY` to the rest of the system?**
