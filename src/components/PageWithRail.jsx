...
// Desktop 8/4 grid: page content left, shared SiteRail right. Not sticky on purpose:
// the rail is taller than the viewport, sticky would hide its lower modules until page end.
