...
const CATEGORY_COLORS = {
  ...
  'Pierwszy Raz':   { bg: 'rgba(157,78,222,0.12)',   color: '#d4af37', border: 'rgba(157,78,222,0.3)' },
  'Bez Osądu':      { bg: 'rgba(157,78,221,0.12)',  color: '#d4af37', border: 'rgba(157,78,221,0.3)' },
...
export function ArticleDetailPage() {
  ...
  return (
    <div className="bg-background min-h-screen text-on-surface">
      ...
      <div className="lg:flex lg:gap-10 lg:justify-center max-w-[1120px] mx-auto">
      <div className="w-full min-w-0 flex-1">
      {/* Back bar */}
      <div className="max-w-3xl mx-auto px-6 md:px-16 pt-8">
        <Link href="/magazyn">
      ...
      {/* Article */}
      <article className="max-w-3xl mx-auto px-6 md:px-16 pt-10 pb-24">
