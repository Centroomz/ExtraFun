...
export const MONTH_THEMES = {
  ...
  10: {
    ...
    // image celowo puste — static cover (pola_partner_hero_pazdziernik_flux.png)
    // jeszcze nie wgrany do Supabase bucketu. TODO patrz memory project_extrafun_october_hero_swap_todo.
